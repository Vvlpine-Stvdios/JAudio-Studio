...
| `s16`    | A Signed, 16-bit (2-byte) Integer       | n ∈ [-32,768, 32,767] ∋ ℤ               | Extremely rarely used, as most things don't need negative numbers.                                                                                                   |
| `s24`    | A Signed, 24-bit (3-byte) Integer       | n ∈ [-8,388,608, 8,388,607] ∋ ℤ         | Extremely rarely used, as most things don't need negative numbers.                                                                                                   |
| `s32`    | A Signed, 32-bit (4-byte) Integer       | n ∈ [-2,147,483,648, 2,147,483,647] ∋ ℤ | Extremely rarely used, as most things don't need negative numbers.                                                                                                   |
...
| `ub32`   | An Unsigned, 32-bit (4-byte) Boolean    | 0 or 1                                  | 0 is false, 1 is true.                                                                                                                                               |
| `sb32`   | A Signed, 32-bit (4-byte) Boolean       | 0 or -1                                 | Because we're special, 0 is false, -1 is true.                                                                                                                       |
